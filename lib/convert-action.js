...
module.exports = (options, type, files) => {
  ...
  var { language, validate, scheme, destination, marktop, partof, creator } = options
  ...
  while (files.length > 0) {
    ...
    try {
      let steps = convert({ from, to, type, language, validate, registry, scheme, destination, partof, creator, marktop, clean })
